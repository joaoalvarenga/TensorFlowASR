...
python3 test_subword_conformer.py --saved /home/joao/mestrado/experiments/conformer_all_datasets_coral_without_cetuc_voxforge/latest.h5 --subwords /home/joao/mestrado/datasets/conformer_subwords.subwords --output_name test_all_datasets_coral_without_cetuc_voxforge >> test.out 2>&1
